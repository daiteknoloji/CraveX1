#!/bin/bash
# Netlify CLI Manuel Deploy - Bash Script

# Netlify CLI ile manuel deploy başlatmak için bash script
...
# Proje dizinine git
cd "$HOME/Desktop/www-backup" || cd "/mnt/c/Users/Can Cakir/Desktop/www-backup"
